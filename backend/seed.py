from clara_agent.db import database_summary
from clara_agent.db import reset_and_seed_database
...
SEED_DATA = {
    ...
    "images": [
        {
            ...
            "category": "SYSTEM",
            "metadata": "Core security evidence image showing a hardened digital operations environment. Useful for references involving encryption, authentication, and protected infrastructure.",
            "links": ["3"],
        },
        {
            "id": "img2",
            ...
            "category": "SATELLITE",
            "metadata": "Orbital network visualization for uplink, satellite relay, and wide-area communication concepts. Useful when documenting signal routing and remote telemetry.",
            "links": ["2"],
        },
        {
            "id": "img3",
            ...
            "category": "HARDWARE",
            "metadata": "Server hardware and infrastructure reference image. Useful for physical compute, rack systems, and local processing notes.",
            "links": ["1"],
        },
        {
            "id": "img4",
            ...
            "category": "HARDWARE",
            "metadata": "Circuit-level diagnostic image associated with sensor instability and hardware anomalies. Useful for maintenance, fault analysis, and node recovery notes.",
            "links": ["6"],
        },
        {
            "id": "img5",
            ...
            "category": "SYSTEM",
            "metadata": "Operations room style system image for command review, dashboards, and centralized monitoring. Useful for high-level system summaries.",
            "links": ["4"],
        },
    ],
    "tasks": [
    ...
    "mindDump": [
        {
            "id": "mind1",
            "content": "Need to decide whether the graph view should eventually show tasks as nodes too, not just files and images.",
            "processed": False,
            "createdAt": "2026-04-27 08:12:00",
        },
        {
            "id": "mind2",
            "content": "Maybe add a daily review ritual where dumped notes and dumped images are processed into projects before shutdown.",
            "processed": False,
            "createdAt": "2026-04-27 10:45:00",
        },
        {
            "id": "mind3",
            "content": "The PTT latency task should mention that buffer sync is the main suspected issue.",
            "processed": True,
            "createdAt": "2026-04-26 18:20:00",
        },
    ],
}
...
if __name__ == "__main__":
    reset_and_seed_database(SEED_DATA)
    print(f"Seeded clara.db: {database_summary()}")
